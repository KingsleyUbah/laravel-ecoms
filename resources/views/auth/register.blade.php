...
<div class="span9">
	...
	<form class="form-horizontal" method="POST" action="{{ route('register') }}">
		...
		<div class="control-group">
			...
			<div class="controls">
			  <input type="text" id="name" class="@error('name') is-invalid @enderror" name="name" placeholder="First Name" value="{{ old('name') }}" required autocomplete="name" autofocus>
                @error('name')
		...
		<div class="controls">
		  <input type="email" id="email" class="@error('email') is-invalid @enderror" name="email" type="email" placeholder="E-mail" value="{{ old('email') }}" required autocomplete="email">
            @error('email')
                    <span class="alert-danger" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
        ...
        <div class="control-group">
            ...
            <div class="controls">
            <input id="password" class="@error('password') is-invalid @enderror" name="password" type="password" placeholder="Password">
                @error('password')
                    <span class="alert-danger" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
        ...
        <div class="control-group">
            ...
            <div class="controls">
            <input id="password_confirm" class="form-control" name="password_confirmation" type="password" placeholder="Confirm Password" required>                
            </div>
        </div>	  
		<div class="control-group">
        ...
        <div class="alert alert-block alert-error fade in">
		<button type="button" class="close" data-dismiss="alert">×</button>
		This address will be used for your checkouts, please fill the accurate info. <strong>You can change it later in your profile</strong> 
	    </div>	
